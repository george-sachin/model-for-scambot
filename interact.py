...
def run():
    ...
    parser.add_argument("--dataset_path", type=str, default="./data/json_gpt_scam.json", help="Path or url of the dataset. If empty download from S3.")
    parser.add_argument("--dataset_cache", type=str, default='./dataset_cache', help="Path or url of the dataset cache")
    parser.add_argument("--model", type=str, default="model/", help="Model type (gpt or gpt2)")
    parser.add_argument("--model_checkpoint", type=str, default="runs_summary", help="Path, url or short name of the model")
